...
const translations = {
    ...
    zh: {
        ...
        heroHeading: '以旧换新优惠',
        heroTitle: '超值优惠',
        heroSubtitle: '适用于所有产品',
        heroDescription: '使用优惠券可省更多，最高可减70%！',
        heroButton: '立即购买',
        freeShipping: '免费配送',
        onlineOrder: '在线下单',
        saveMoney: '省钱',
        ...
        featuredDescription: '夏季系列 全新现代设计',
        repairServices: '维修服务',
        repairOffer: '所有T恤和配饰最高可享70%折扣',
        exploreMore: '了解更多',
        dealsHeading: '疯狂优惠',
        dealsTitle: '买一送一',
        dealsDescription: '最经典的连衣裙正在cara特卖',
        learnMore: '了解更多',
        seasonHeading: '春/夏',
        seasonTitle: '即将到来的季节',
        collection: '系列',
        seasonSale: '季节特卖',
        winterCollection: '冬季系列 -50% OFF',
        footwearCollection: '全新鞋履系列',
        seasonYear: '春 / 夏 2023',
        tshirt: 'T恤',
        trendyPrints: '全新潮流印花',
        newsletterHeading: '订阅新闻通讯',
        newsletterBody: '获取有关我们最新商店和',
        specialOffers: '特别优惠的邮件更新。',
        ...
        help: '帮助',
        installApp: '安装应用',
        appStore: '来自App Store或Google Play',
        securedPayment: '安全支付网关',
        copyright: '©2023 Anurag Kumar. 版权所有。'
    },
    ja: {
        home: 'ホーム',
        shop: 'ショップ',
...
function setLanguage(lang) {
    ...
    document.documentElement.lang = lang === 'ja' ? 'ja' : lang === 'fr' ? 'fr' : lang === 'zh' ? 'zh' : 'en';
}
